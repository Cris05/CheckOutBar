package it.cristopher.checkoutbar;
...
public class CheckOutBar extends RelativeLayout {
    ...
    public CheckOutBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        this.attrs = attrs;
        initView();
    ...
    public CheckOutBar(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView() {
        this.view = this;
        inflate(context, R.layout.lay_barra, this);
